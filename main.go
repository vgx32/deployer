...
func (dplr *deployer) postWebHook(w http.ResponseWriter, r *http.Request) {
	...
	if hookData.Repository.Namespace != `vgx32` {
...
func deploy() {
	...
	params := &elasticbeanstalk.UpdateEnvironmentInput{
		...
		EnvironmentId:   aws.String("e-piua95jzrk"),
...
"source": "https://github.com/vgx32/deployer",
"version": "%s",
"commit": "%s",
"build": "https://circleci.com/gh/vgx32/deployer/"
}`, version, commit)))
}
